      ...
      <div class="breadcrumb-content-inner">
        <div class="gva-breadcrumb-content">
          <div id="block-gavias-foxin-breadcrumbs" class="text-light block gva-block-breadcrumb block-system block-system-breadcrumb-block no-title">
            <div class="breadcrumb-style" style="background-color:#cef0ea;background-image:url(images/xDigiByte_Worldwide_.jpg.pagespeed.ic.FlJkNuQJQF.jpg);background-position:center top;background-repeat:no-repeat">
              <div class="container">
                                          ...
                                          <div class="column-inner  bg-size-cover">
                                            <div class="column-content-inner">
                                              <div class="widget gsc-heading  align-center style-1 text-dark  wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                                                ...
                                                <h2 class="title"><span>Merchants</span></h2>
                                                <div class="line"></div>
                                                <div class='mrg'>
												<p>A merchant is a person who trades in commodities produced by other people to earn a profit. A merchant historically was anyone involved in business as long as industry, commerce, and trade have existed. The status of the merchant has varied during different periods of history and among different societies. In modern times the term occasionally has been used to refer to a businessperson or someone undertaking activities (commercial or industrial) for the purpose of generating profit, cash flow, sales, and revenue utilizing a combination of human, financial, intellectual and physical capital with a view to fuelling economic development and growth.</p>
