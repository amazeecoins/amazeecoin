                        ...
                        <div class="col-sm-12 col-xs-12">
                          <div class="widget gsc-icon-box left text-dark">
                            ...
                            <div class="highlight_content">
                              ...
                              <div class="desc"> <a href="https://play.google.com/store/apps/details?id=com.btc2amazeecoin" target="_blank"> <a href="https://play.google.com/store/apps/details?id=com.btc2amazeecoin" target="_blank">Download your first AmazeeCoin wallet</a></a> <br>
                                </div>
                            </div>
                          </div>
                        </div>
            ...
            <div class="breadcrumb-style" style="background-color:#cef0ea;background-image:url(images/about.jpg);background-position:center top;background-repeat:no-repeat">
              <div class="container">
                <div class="breadcrumb-content-main">
                  <h2 class="page-title">About Amazeecoin </h2>
                  <div class="">
                    <div class="content block-content">
                                          ...
                                          <div class="column-inner  bg-size-cover">
                                            <div class="column-content-inner">
                                              <div class="widget gsc-heading  align-center style-1 text-dark  wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                                                ...
                                                <h2 class="title"><span> Amazeecoin</span></h2>
                                                <div class="line"></div>
                                                <div class='mrg'>
												<p class="desc">Amazeecoin is a decentralized platform that run accurately as programmed without any peril of downtime, restriction, deceit or third party intervention. A very powerful joint international infrastructure that can move value around and symbolize the ownership of property.</p>
												
												<p>This enables developers to create markets, store registries of debts or promises, move funds in accordance with instructions given long in the past and many other things that have not been invented yet, all without a middle man or counterparty risk.</p>
												<p>Global business is quickly changing. Businesses are gradually more global from day one and consumers are programmed to expect on demand delivery of services and information. Yet, the current communications for payments is unhappily insufficient to meet these needs.
