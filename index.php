...
$urlal2 = "https://amazeecoin.com/coinApi/todaysrate_usd.php";
$json = json_decode(file_get_contents($urlal2), true);
$al2 = $json["usdrate"];

?>                         
                         <li><span><i class="fa fa-line-chart"> Live  Price: <strong><span id="digibytevalue">1 AME = 
                             <?php echo '$ '.$al2; ?>
                                         </span></strong> </i></span> <span style="font-size: 16px;">|</span></li>
                        <li><span> <i class="fa "><strong><span >1 BTC = <?php
...
<!--                        <li><span><i class="fa fa-clock-o"> 24hr USD Vol. $<strong><span ></span></strong></i></span></li>
  ...
  <script type="text/javascript">
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:1650px;height:580px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="loading" class="jssorl-oval" style="position:absolute;top:0px;left:0px;text-align:center;background-color:rgba(0,0,0,0.7);">
            <img style="margin-top:-19.0px;position:relative;top:50%;width:38px;height:38px;" src="img/oval.svg"  alt="Amazeecoin"/>
        </div>
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1650px;height:580px;overflow:hidden;">
            <div data-b="0">
                <img data-u="image" src="img/04.jpg"  alt="Amazeecoin"/>
                <div style="position:absolute;top:107px;left:460px;width:860px;height:410px;z-index:0;">
                    <img data-u="caption" data-t="0" style="position:absolute;top:-300px;left:89px;width:210px;height:178px;z-index:0;" src="img/mock-pc.png"  alt="Amazeecoin"/>
                    <img data-u="caption" data-t="1" style="position:absolute;top:55px;left:-200px;width:200px;height:144px;z-index:0;" src="img/mock-ipad.png"  alt="Amazeecoin"/>
                    <img data-u="caption" data-t="2" style="position:absolute;top:88px;left:420px;width:320px;height:320px;z-index:0;" src="img/mock-laptop.png"  alt="Amazeecoin"/>
                </div>
                <div data-u="caption" data-t="3" data-to="0% 100%" style="position:absolute;top:385px;left:-100px;width:257px;height:127px;z-index:0;">
                    <div style="position:absolute;top:4px;left:34px;width:198px;height:112px;z-index:0; overflow:hidden;">
                        <img data-u="caption" data-t="4" style="position:absolute;top:-2px;left:-2px;width:408px;height:116px;z-index:0;" src="img/mock-phone-slider-flat.jpg"  alt="Amazeecoin"/>
                    </div>
                    <img style="position:absolute;top:0px;left:0px;width:257px;height:127px;z-index:0;" src="img/mock-phone.png"  alt="Amazeecoin"/>
                    <img data-u="caption" data-t="5" style="position:absolute;top:22px;left:139px;width:108px;height:108px;z-index:0;" src="img/circle-hollow.png"  alt="Amazeecoin"/>
                    <img data-u="caption" data-t="6" style="position:absolute;top:31px;left:148px;width:90px;height:90px;z-index:0;" src="img/circle-solid.png"  alt="Amazeecoin"/>
                    <img data-u="caption" data-t="7" style="position:absolute;top:100px;left:300px;width:63px;height:77px;z-index:0;" src="img/hand.png"  alt="Amazeecoin"/>
                    <img data-u="caption" data-t="8" style="position:absolute;top:-44px;left:255px;width:75px;height:20px;z-index:0;" src="img/swipe-arrow.png"  alt="Amazeecoin"/>
                </div>
            ...
            <div data-b="1" data-p="170.00">
                <img data-u="image" src="img/02.jpg"  alt="Amazeecoin"/>
                ...
                <div data-u="caption" data-t="15" data-3d="1" style="position:absolute;top:70px;left:182px;width:616px;height:150px;z-index:0;">
                    <img data-u="caption" data-t="16" style="position:absolute;top:22px;left:266px;width:84px;height:84px;z-index:0;" src="img/ios.png"  alt="Amazeecoin"/>
                    <img data-u="caption" data-t="17" style="position:absolute;top:16px;left:260px;width:96px;height:96px;z-index:0;" src="img/circle.png"  alt="Amazeecoin"/>
                    ...
                    <img data-u="caption" data-t="19" style="position:absolute;top:22px;left:22px;width:84px;height:84px;z-index:0;" src="img/android.png"  alt="Amazeecoin"/>
                    <img data-u="caption" data-t="20" style="position:absolute;top:16px;left:16px;width:96px;height:96px;z-index:0;" src="img/circle.png"  alt="Amazeecoin"/>
                    ...
                    <img data-u="caption" data-t="22" style="position:absolute;top:22px;left:510px;width:84px;height:84px;z-index:0;" src="img/windows.png"  alt="Amazeecoin"/>
                    <img data-u="caption" data-t="23" style="position:absolute;top:16px;left:504px;width:96px;height:96px;z-index:0;" src="img/circle.png"  alt="Amazeecoin"/>
          ...
          <div id="page-main-content" class="main-content">
            <div class="main-content-inner">
              <div class="content-main">
                <div>
                  <article data-history-node-id="142" typeof="schema:WebPage" class="node node--type-page node--view-mode-full">
                    <header> </header>
...
About</h4>
                            ...
                            <div class="update">
                              <div class="container">
                                <div class="widget gsc-heading  align-center style-1 text-dark  wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                                              ...
                                              <p><img src="images/update.png"  alt="Amazeecoin"/></p>
							    ...
							    <div class="widget gsc-heading  align-center style-1 text-dark  wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
											  ...
											  <div class="serve col-md-4">
												...
												<div class="icnnt col-md-12">
                                                                                                    <p><img style="margin: 0 auto;" src="images/cloud.png" class="img-responsive"  alt="Amazeecoin"/></p>
											   ...
											   <div class="serve col-md-4">
												...
												<div class="icnnt col-md-12">
												 <p><img src="images/money-bag.png" class="img-responsive"  alt="Amazeecoin" style="margin: 0 auto;"/></p>
											   ...
											   <div class="serve col-md-4">
												...
												<div class="icnnt col-md-12">
												 <p><img  src="images/actions.png" class="img-responsive"  alt="Amazeecoin" style="margin: 0 auto;"/></p>
											   ...
											   <div class="serve col-md-4">
												...
												<div class="icnnt col-md-12">
												 <p><img src="images/cable.png" class="img-responsive"  alt="Amazeecoin" style="margin: 0 auto;"/></p>
											   ...
											   <div class="serve col-md-4">
												...
												<div class="icnnt col-md-12">
												 <p><img src="images/money.png" class="img-responsive"  alt="Amazeecoin" style="margin: 0 auto;"/></p>
											   ...
											   <div class="serve col-md-4">
												...
												<div class="icnnt col-md-12">
												 <p><img src="images/cloud.png" class="img-responsive"  alt="Amazeecoin" style="margin: 0 auto;"/></p>
                            ...
                            <div class="video">
                             <div class="widget gsc-heading  align-center style-1 text-dark  wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                                ...
                                <iframe height="450" style="width: 100%" src="https://www.youtube.com/embed/DfoyuBTudDs" allowfullscreen></iframe>
